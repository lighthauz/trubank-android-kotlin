 ...
 * Use the [TrucodeContainerFragment.newInstance] factory method to
...
class TrucodeContainerFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment TrucodeContainerFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TrucodeContainerFragment().apply {
